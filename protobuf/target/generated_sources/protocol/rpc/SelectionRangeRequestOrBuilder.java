...
public interface SelectionRangeRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:protocol.rpc.SelectionRangeRequest)
   ...
   */
  java.util.List<protocol.Position> 
      getPositionsList();
  /**
   * <pre>
   * The positions inside the text document.
   ...
   * <code>repeated .protocol.Position positions = 4;</code>
   */
  protocol.Position getPositions(int index);
  /**
   * <pre>
   * The positions inside the text document.
   * </pre>
   ...
   * <code>repeated .protocol.Position positions = 4;</code>
   */
  java.util.List<? extends protocol.PositionOrBuilder> 
   ...
   * <code>repeated .protocol.Position positions = 4;</code>
   */
  protocol.PositionOrBuilder getPositionsOrBuilder(
      int index);
}
