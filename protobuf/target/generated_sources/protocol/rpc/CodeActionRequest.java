 ...
 * </pre>
 *
 * Protobuf type {@code protocol.rpc.CodeActionRequest}
 */
public  final class CodeActionRequest extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:protocol.rpc.CodeActionRequest)
    CodeActionRequestOrBuilder {
  // Use CodeActionRequest.newBuilder() to construct.
  private CodeActionRequest(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
    super(builder);
  }
  private CodeActionRequest() {
  }
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 42: {
            protocol.rpc.CodeActionContext.Builder subBuilder = null;
            if (context_ != null) {
              subBuilder = context_.toBuilder();
            }
            context_ = input.readMessage(protocol.rpc.CodeActionContext.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return protocol.rpc.RpcProto.internal_static_protocol_rpc_CodeActionRequest_descriptor;
  }

  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return protocol.rpc.RpcProto.internal_static_protocol_rpc_CodeActionRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            protocol.rpc.CodeActionRequest.class, protocol.rpc.CodeActionRequest.Builder.class);
  }
  ...
  private protocol.rpc.CodeActionContext context_;
  /**
   * <pre>
   ...
   * <code>.protocol.rpc.CodeActionContext context = 5 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  public protocol.rpc.CodeActionContext getContext() {
    return context_ == null ? protocol.rpc.CodeActionContext.getDefaultInstance() : context_;
  }
  /**
   * <pre>
   * Context carrying additional information.
   ...
   * <code>.protocol.rpc.CodeActionContext context = 5 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  public protocol.rpc.CodeActionContextOrBuilder getContextOrBuilder() {
    return getContext();
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof protocol.rpc.CodeActionRequest)) {
      return super.equals(obj);
    }
    protocol.rpc.CodeActionRequest other = (protocol.rpc.CodeActionRequest) obj;
  ...
  public static protocol.rpc.CodeActionRequest parseFrom(
  ...
  public static protocol.rpc.CodeActionRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static protocol.rpc.CodeActionRequest parseFrom(
  ...
  public static protocol.rpc.CodeActionRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static protocol.rpc.CodeActionRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static protocol.rpc.CodeActionRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(protocol.rpc.CodeActionRequest prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:protocol.rpc.CodeActionRequest)
      protocol.rpc.CodeActionRequestOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return protocol.rpc.RpcProto.internal_static_protocol_rpc_CodeActionRequest_descriptor;
    }
    ...
    // Construct using protocol.rpc.CodeActionRequest.newBuilder()
    private Builder() {
    ...
    public protocol.rpc.CodeActionRequest getDefaultInstanceForType() {
      return protocol.rpc.CodeActionRequest.getDefaultInstance();
    }

    public protocol.rpc.CodeActionRequest build() {
      protocol.rpc.CodeActionRequest result = buildPartial();
    ...
    public protocol.rpc.CodeActionRequest buildPartial() {
      protocol.rpc.CodeActionRequest result = new protocol.rpc.CodeActionRequest(this);
      if (workDoneProgressParamsBuilder_ == null) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof protocol.rpc.CodeActionRequest) {
        return mergeFrom((protocol.rpc.CodeActionRequest)other);
      } else {
    ...
    public Builder mergeFrom(protocol.rpc.CodeActionRequest other) {
      if (other == protocol.rpc.CodeActionRequest.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      protocol.rpc.CodeActionRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (protocol.rpc.CodeActionRequest) e.getUnfinishedMessage();
    ...
    private protocol.rpc.CodeActionContext context_ = null;
    private com.google.protobuf.SingleFieldBuilderV3<
        protocol.rpc.CodeActionContext, protocol.rpc.CodeActionContext.Builder, protocol.rpc.CodeActionContextOrBuilder> contextBuilder_;
    /**
     * <pre>
     * Context carrying additional information.
     * </pre>
     ...
     * <code>.protocol.rpc.CodeActionContext context = 5 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    public Builder setContext(protocol.rpc.CodeActionContext value) {
      if (contextBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setContext(
        protocol.rpc.CodeActionContext.Builder builderForValue) {
      if (contextBuilder_ == null) {
     ...
     * <code>.protocol.rpc.CodeActionContext context = 5 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    public Builder mergeContext(protocol.rpc.CodeActionContext value) {
      if (contextBuilder_ == null) {
        if (context_ != null) {
          context_ =
            protocol.rpc.CodeActionContext.newBuilder(context_).mergeFrom(value).buildPartial();
        } else {
          context_ = value;
        }
        onChanged();
     ...
     * <code>.protocol.rpc.CodeActionContext context = 5 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    public protocol.rpc.CodeActionContext.Builder getContextBuilder() {
    ...
    public protocol.rpc.CodeActionContextOrBuilder getContextOrBuilder() {
      if (contextBuilder_ != null) {
        ...
        return context_ == null ?
            protocol.rpc.CodeActionContext.getDefaultInstance() : context_;
      }
    }
    /**
     * <pre>
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        protocol.rpc.CodeActionContext, protocol.rpc.CodeActionContext.Builder, protocol.rpc.CodeActionContextOrBuilder> 
    ...
    // @@protoc_insertion_point(builder_scope:protocol.rpc.CodeActionRequest)
  }

  // @@protoc_insertion_point(class_scope:protocol.rpc.CodeActionRequest)
  private static final protocol.rpc.CodeActionRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new protocol.rpc.CodeActionRequest();
  }

  public static protocol.rpc.CodeActionRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final com.google.protobuf.Parser<CodeActionRequest>
      PARSER = new com.google.protobuf.AbstractParser<CodeActionRequest>() {
    public CodeActionRequest parsePartialFrom(
        com.google.protobuf.CodedInputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
        return new CodeActionRequest(input, extensionRegistry);
    }
  };

  public static com.google.protobuf.Parser<CodeActionRequest> parser() {
    return PARSER;
  }

  @java.lang.Override
  public com.google.protobuf.Parser<CodeActionRequest> getParserForType() {
    return PARSER;
  }
