...
public interface ReferenceRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:protocol.rpc.ReferenceRequest)
   ...
   * <code>.protocol.rpc.ReferenceContext context = 4 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  protocol.rpc.ReferenceContext getContext();
  /**
   * <code>.protocol.rpc.ReferenceContext context = 4 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  protocol.rpc.ReferenceContextOrBuilder getContextOrBuilder();
}
