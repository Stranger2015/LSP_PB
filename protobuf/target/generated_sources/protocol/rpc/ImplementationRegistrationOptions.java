 ...
 * </pre>
 *
 * Protobuf type {@code protocol.rpc.ImplementationRegistrationOptions}
 */
public  final class ImplementationRegistrationOptions extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:protocol.rpc.ImplementationRegistrationOptions)
    ImplementationRegistrationOptionsOrBuilder {
  // Use ImplementationRegistrationOptions.newBuilder() to construct.
  private ImplementationRegistrationOptions(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
    super(builder);
  }
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            if (implementationOptions_ != null) {
              subBuilder = implementationOptions_.toBuilder();
            }
            implementationOptions_ = input.readMessage(protocol.rpc.ImplementationOptions.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom(implementationOptions_);
              implementationOptions_ = subBuilder.buildPartial();
            }
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return protocol.rpc.RpcProto.internal_static_protocol_rpc_ImplementationRegistrationOptions_descriptor;
  }

  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return protocol.rpc.RpcProto.internal_static_protocol_rpc_ImplementationRegistrationOptions_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            protocol.rpc.ImplementationRegistrationOptions.class, protocol.rpc.ImplementationRegistrationOptions.Builder.class);
  }
  ...
  public static final int IMPLEMENTATION_OPTIONS_FIELD_NUMBER = 2;
  private protocol.rpc.ImplementationOptions implementationOptions_;
  /**
   * <pre>
   * extends
   * </pre>
   ...
   */
  public boolean hasImplementationOptions() {
    return implementationOptions_ != null;
  }
  /**
   * <pre>
   * extends
  ...
  public protocol.rpc.ImplementationOptions getImplementationOptions() {
    return implementationOptions_ == null ? protocol.rpc.ImplementationOptions.getDefaultInstance() : implementationOptions_;
  }
  /**
   * <pre>
   * extends
  ...
  public protocol.rpc.ImplementationOptionsOrBuilder getImplementationOptionsOrBuilder() {
    return getImplementationOptions();
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (implementationOptions_ != null) {
      output.writeMessage(2, getImplementationOptions());
    }
    if (staticRegistrationOptions_ != null) {
  ...
  public int getSerializedSize() {
    ...
    if (implementationOptions_ != null) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(2, getImplementationOptions());
    }
    if (staticRegistrationOptions_ != null) {
      size += com.google.protobuf.CodedOutputStream
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof protocol.rpc.ImplementationRegistrationOptions)) {
      return super.equals(obj);
    }
    protocol.rpc.ImplementationRegistrationOptions other = (protocol.rpc.ImplementationRegistrationOptions) obj;
    ...
    result = result && (hasImplementationOptions() == other.hasImplementationOptions());
  ...
  public static protocol.rpc.ImplementationRegistrationOptions parseFrom(
  ...
  public static protocol.rpc.ImplementationRegistrationOptions parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static protocol.rpc.ImplementationRegistrationOptions parseFrom(
  ...
  public static protocol.rpc.ImplementationRegistrationOptions parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static protocol.rpc.ImplementationRegistrationOptions parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static protocol.rpc.ImplementationRegistrationOptions parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(protocol.rpc.ImplementationRegistrationOptions prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:protocol.rpc.ImplementationRegistrationOptions)
      protocol.rpc.ImplementationRegistrationOptionsOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return protocol.rpc.RpcProto.internal_static_protocol_rpc_ImplementationRegistrationOptions_descriptor;
    }
    ...
    // Construct using protocol.rpc.ImplementationRegistrationOptions.newBuilder()
    private Builder() {
    ...
    public Builder clear() {
      ...
      if (implementationOptionsBuilder_ == null) {
        implementationOptions_ = null;
      } else {
        implementationOptions_ = null;
        implementationOptionsBuilder_ = null;
      }
    ...
    public protocol.rpc.ImplementationRegistrationOptions getDefaultInstanceForType() {
      return protocol.rpc.ImplementationRegistrationOptions.getDefaultInstance();
    }

    public protocol.rpc.ImplementationRegistrationOptions build() {
      protocol.rpc.ImplementationRegistrationOptions result = buildPartial();
    ...
    public protocol.rpc.ImplementationRegistrationOptions buildPartial() {
      protocol.rpc.ImplementationRegistrationOptions result = new protocol.rpc.ImplementationRegistrationOptions(this);
      if (textDocumentRegistrationOptionsBuilder_ == null) {
      ...
      if (implementationOptionsBuilder_ == null) {
        result.implementationOptions_ = implementationOptions_;
      } else {
        result.implementationOptions_ = implementationOptionsBuilder_.build();
      }
      if (staticRegistrationOptionsBuilder_ == null) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof protocol.rpc.ImplementationRegistrationOptions) {
        return mergeFrom((protocol.rpc.ImplementationRegistrationOptions)other);
      } else {
    ...
    public Builder mergeFrom(protocol.rpc.ImplementationRegistrationOptions other) {
      if (other == protocol.rpc.ImplementationRegistrationOptions.getDefaultInstance()) return this;
      if (other.hasTextDocumentRegistrationOptions()) {
        mergeTextDocumentRegistrationOptions(other.getTextDocumentRegistrationOptions());
      }
      if (other.hasImplementationOptions()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      protocol.rpc.ImplementationRegistrationOptions parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (protocol.rpc.ImplementationRegistrationOptions) e.getUnfinishedMessage();
    ...
    private protocol.rpc.ImplementationOptions implementationOptions_ = null;
    private com.google.protobuf.SingleFieldBuilderV3<
     ...
     */
    public boolean hasImplementationOptions() {
      return implementationOptionsBuilder_ != null || implementationOptions_ != null;
    }
    /**
     * <pre>
     * extends
    ...
    public Builder setImplementationOptions(
      ...
      if (implementationOptionsBuilder_ == null) {
        implementationOptions_ = builderForValue.build();
        onChanged();
      } else {
    ...
    public Builder mergeImplementationOptions(protocol.rpc.ImplementationOptions value) {
      if (implementationOptionsBuilder_ == null) {
        if (implementationOptions_ != null) {
          implementationOptions_ =
            protocol.rpc.ImplementationOptions.newBuilder(implementationOptions_).mergeFrom(value).buildPartial();
        } else {
          implementationOptions_ = value;
        }
        onChanged();
    ...
    public protocol.rpc.ImplementationOptionsOrBuilder getImplementationOptionsOrBuilder() {
      if (implementationOptionsBuilder_ != null) {
        ...
        return implementationOptions_ == null ?
            protocol.rpc.ImplementationOptions.getDefaultInstance() : implementationOptions_;
      }
    }
    /**
     * <pre>
    ...
    // @@protoc_insertion_point(builder_scope:protocol.rpc.ImplementationRegistrationOptions)
  }

  // @@protoc_insertion_point(class_scope:protocol.rpc.ImplementationRegistrationOptions)
  private static final protocol.rpc.ImplementationRegistrationOptions DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new protocol.rpc.ImplementationRegistrationOptions();
  }

  public static protocol.rpc.ImplementationRegistrationOptions getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final com.google.protobuf.Parser<ImplementationRegistrationOptions>
      PARSER = new com.google.protobuf.AbstractParser<ImplementationRegistrationOptions>() {
    public ImplementationRegistrationOptions parsePartialFrom(
        com.google.protobuf.CodedInputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
        return new ImplementationRegistrationOptions(input, extensionRegistry);
    }
  };

  public static com.google.protobuf.Parser<ImplementationRegistrationOptions> parser() {
    return PARSER;
  }

  @java.lang.Override
  public com.google.protobuf.Parser<ImplementationRegistrationOptions> getParserForType() {
    return PARSER;
  }
